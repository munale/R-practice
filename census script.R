...
url4 <- "http://api.census.gov/data/2010/sf1?key=k1&get=P0010001,NAME,REGION&for=state:*"
download.file(url4, destfile="byrace", method="curl")

url5 <- "http://api.census.gov/data/2010/sf1?key=k1&get=P0030001,NAME,P0030002,P0030003,P0030004,P0030005,P0030006,P0030007,P0030008&for=state:*"
download.file(url5, destfile="therace", method="curl")

url6 <- "http://api.census.gov/data/2010/sf1?get=NAME,P0010001,P0030001&for=state:*&in=county:*&key=k1"


# example urls
#http://api.census.gov/data/2010/sf1?key=k1&get=P0030001,NAME,P0030002,P0030003,P0030004,P0030005,P0030006,P0030007,P0030008&for=congressional+district:*&in=state:17
#http://api.census.gov/data/2010/sf1?get=P0010001,NAME&in=state:*&key=k1&for=county:*
